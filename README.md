...
O Grype foi um pouco mais facil, quando utilizei a primeira vez com as configs sugeridas vi que ele não tinha achado nenhuma dependencia, foi ai então que percebi que não tinha nenhum lock.json, então rodei o npm install para que ele fosse criado, dando então a visibilidade para o grype.
